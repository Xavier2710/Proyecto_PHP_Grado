...
include('../../../app/controllers/preguntas/show_pregunta_docente.php');
                    ...
                    <tr>
                      ...
                      <td style="text-align: center; ">
                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                          ...
                          <form action="<?=APP_URL;?>/app/controllers/preguntas/delete_pregunta_docente.php" onclick="preguntar<?=$codigo_pre;?>(event)" method="post" id="miformulario<?=$codigo_pre;?>">
