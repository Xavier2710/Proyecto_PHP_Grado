...
include('../../../app/controllers/cuestionarios/show_cuestionario_docente.php');
                    ...
                    <tr>
                      ...
                      <td style="text-align: center; ">
                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                          ...
                          <form action="<?=APP_URL;?>/app/controllers/cuestionarios/delete_cuestionario_docente.php" onclick="preguntar<?=$codigo_cu;?>(event)" method="post" id="miformulario<?=$codigo_cu;?>">
