...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?=APP_URL;?>/layout/estudiante/index_estudiante.php" class="nav-link"><strong><?=APP_NAME;?></strong></a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #D5B256;">
    <!-- Brand Logo -->
    <a href="<?=APP_URL;?>/layout/estudiante/index_estudiante.php" class="brand-link">
