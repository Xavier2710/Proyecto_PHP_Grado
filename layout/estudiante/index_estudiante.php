                ...
                <div class="col-md-13">
                    ...
                    <div class="card card-widget widget-user">
                      ...
                      <div class="widget-user-header text-white" style="background: url('<?=APP_URL;?>/public/dist/img/portada.jpg') center center;">
                        ...
                        <h3 class="widget-user-username text-right" style="color:#F2F2F2"><?=$rol_usuario;?></h3>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="card mb-2 bg-gradient-dark">
                          <img class="card-img-top" src="<?=APP_URL;?>/public/dist/img/imagen 3.jpg" alt="Dist Photo 1">
                      ...
                      <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="card mb-2">
                          <img class="card-img-top" src="<?=APP_URL;?>/public/dist/img/imagen 2.jpg" alt="Dist Photo 2">
                          <div class="card-img-overlay d-flex flex-column justify-content-end">
                            <a class="text-white" style="color:#F2F2F2">Dimensiones</a>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12 col-lg-6 col-xl-4">
                        <div class="card mb-2">
                          <img class="card-img-top" src="<?=APP_URL;?>/public/dist/img/imagen 1.jpg" alt="Dist Photo 3">
                          <div class="card-img-overlay d-flex flex-column justify-content-end"">
