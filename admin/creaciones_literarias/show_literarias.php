                    ...
                    <tr>
                      ...
                      <td style="text-align: center; ">
                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                          <a href="<?=APP_URL;?>/app/controllers/creaciones_literarias/download_literaria_administrador.php?id=<?=$codigo_literaria;?>" type="button" class="btn btn-primary" title="Descargar" style="background-color: #F2D98D; border-radius: 10px 6px 6px 0px; border-color: #F2D98D; color: red;"><i class="bi bi-download"></i></a>
