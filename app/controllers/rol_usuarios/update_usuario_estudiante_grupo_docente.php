...
if(($txt_codigo == "")){
    ...
    $_SESSION['icono'] = "info";
    header('Location:'.APP_URL."/layout/docente/estudiantes/edit_grupo_estudiante.php?id=".$txt_codigo);
} else {
    ...
    try {
        if($sentencia->execute()) {
            ...
            header('Location:'.APP_URL."/layout/docente/estudiantes/show_estudiantes.php");
        } else {
            session_start();
        ...
        $_SESSION['icono'] = "error";
        header('Location:'.APP_URL."/layout/docente/edit_grupo_estudiante.php?id=".$txt_codigo);
    }
}
?>
